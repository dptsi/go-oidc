...
func TestUserInfoEndpoint(t *testing.T) {
	...
	userInfoJSON := `{
        "alternate_email": "rja.akbar@gmail.com",
        ...
        "picture": "",
        "preferred_username": "051100122",
        "reg_id": "198701032014041001",
        "role": null,
        "sub": "05728719-D825-4808-AA8C-63EBB3FF4D62",
        "suspended": false,
        "updated_at": "2023-04-05 08:25:48.400",
	...
	tests := []struct {
	...
	}{
		{
			...
			wantUserInfo: UserInfo{
				AlternateEmail:         "rja.akbar@gmail.com",
				AlternateEmailVerified: true,
				Birthdate:              "1987-01-03",
				Email:                  "rja.akbar@gmail.com",
				EmailVerified:          false,
				Enabled:                true,
				Gender:                 "male",
				Group:                  make([]Group, 0),
				...
				PhoneVerified:          false,
				Picture:                "",
				PreferredUsername:      "rja.akbar@gmail.com",
				RegID:                  "rja.akbar@gmail.com",
				Role:                   []Role{},
				Sub:                    "rja.akbar@gmail.com",
				Suspended:              false,
				UpdatedAt:              "2023-04-05 08:25:48.400",
				Zoneinfo:               "Asia/Jakarta",
